...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://stg-api.stackbit.com/pull/5fda249b90c24b0015737dd6
...
To start editing your site, you can use the Sanity interface at https://magnificent-paprika-a249b.sanity.studio/.
...
Generated at `2020-12-16T15:16:08.730Z` by Stackbit version `0.3.40`.